...
./bin/Game.o:./src/Game.cpp ./include/SDL2/SDL.h ./include/Game.h ./include/SDL2/SDL_image.h
	$(CC) -o ./bin/Game.o -c ./src/Game.cpp -I ./include/SDL2/ -I ./include/

./bin/Resource.o:./src/Resource.cpp ./include/SDL2/SDL.h ./include/Resource.h
